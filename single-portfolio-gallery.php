    ...
    <div class="wrapper fixed__footer">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6">
                            <nav class="mainmenu__nav hidden-xs hidden-sm">
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="portfolio-gutter-box-3.php">portfolio</a>
                                        <ul class="dropdown">
                                            <li><a href="portfolio-gutter-box-3.php">Boxed Gutter 3 Col</a></li>
                                            <li><a href="portfolio-gutter-full-wide-4.php">Wide Gutter 4 Col </a></li>
                                            <li><a href="portfolio-card-box-3.php">Card Gutter 3 Col </a></li>
                                            <li><a href="portfolio-masonry-3.php">Masonry Box 3 Col </a></li>
                                            <li><a href="portfolio-gutter-masonry-fullwide-4.php">Masonry Wide 4 Col </a></li>
                                            <li><a href="portfolio-gutter-box-3-carousel.php">carousel Gutter 3 Col </a></li>
                                            <li><a href="portfolio-justified-box-3.php">justified box 3 Col</a></li>
                                            <li><a href="single-portfolio-gallery.php">Portfolio Details </a></li>
                                        </ul>
                                    </li>
                                    <li class="drop"><a href="blog.php">Blog</a>
                                        <ul class="dropdown">
                                            <li><a href="blog.php">blog 3 column</a></li>
                                            <li><a href="blog-2-col-rightsidebar.php">2 col right siderbar</a></li>
                                            <li><a href="blog-details-left-sidebar.php"> blog details</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="drop"><a href="#">pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="product-details-sticky-right.php">product details</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">single portfolio gallery</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.php">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">single portfolio gallery</span>
                                </nav>
                            </div>
                        </div>
                    </div>
        ...
        <div class="single-portfolio-area bg__white ptb--100">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="single-portfolio-img mb--50">
                            <img src="images/portfolio/single-portfolio/3.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="portfolio-description">
                            <h2>portfolio name</h2>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliqu erat volutpat. Ut wisi enim ad minim veniamsed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliqu erat volutpat. Ut wisi enim ad minim veniamdolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliqu erat volutpat.</p>
        ...
        <div class="portfolio-grid-area bg__white pb--70">
		    <div class="container">
                <div class="portfolio-style">
                    <div class="row grid">
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item cat1 cat3">
                            <div class="single-portfolio single-portfolio-gallery mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="images/portfolio/masonry-col3/1.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="images/portfolio/masonry-col3/1.jpg">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item cat5 cat2">
                            <div class="single-portfolio single-portfolio-gallery mb--30">
                                <div class="portfolio-img">
                                    ...
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="images/portfolio/masonry-col3/2.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
                                        </a>
                                    </div>
                                </div>				
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item cat2 cat3">
                            <div class="single-portfolio single-portfolio-gallery mb--30">
                                <div class="portfolio-img">
                                    ...
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="images/portfolio/masonry-col3/3.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
                                        </a>
                                    </div>
                                </div>				
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item cat5 cat1">
                            <div class="single-portfolio single-portfolio-gallery mb--30">
                                <div class="portfolio-img">
                                    ...
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="images/portfolio/masonry-col3/4.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
                                        </a>
                                    </div>
                                </div>				
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item cat2 cat5">
                            <div class="single-portfolio single-portfolio-gallery mb--30">
                                <div class="portfolio-img">
                                    <a href="single-portfolio.php">
                                        <img src="images/portfolio/masonry-col3/5.jpg" alt="" />
                                    </a>
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="images/portfolio/masonry-col3/5.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
                                        </a>
                                    </div>
                                </div>				
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item cat1 cat3">
                            <div class="single-portfolio single-portfolio-gallery mb--30">
                                <div class="portfolio-img">
                                    ...
                                    <div class="portfolio-icon">
                                        <a class="img-poppu" href="images/portfolio/masonry-col3/6.jpg">
                                            <i class="zmdi zmdi-instagram"></i>
                                        </a>
                                    </div>
                                </div>				
